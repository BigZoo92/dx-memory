...
import { ageSince, computeIncidentSummary, formatDuration } from '@signalops/flow-domain'
import {
  Card,
  CardHeader,
  EmptyState,
...
import { useAllIncidents } from '../../shared/api/queries'
import { QueryState } from '../../shared/QueryState'
import { REFERENCE_NOW_MS } from '../../app/config'
              ...
              <tbody>
                {filtered.map((incident) => (
                  <tr key={incident.id}>
                    ...
                    <td className={styles.mono}>{incident.linkedSignalIds.length}</td>
