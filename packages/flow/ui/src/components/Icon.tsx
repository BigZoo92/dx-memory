...
/** Line-icon names used across the shell and cards (paths ported from the reference). */
...
/** Stroked line icon. Inherits `currentColor`; marked aria-hidden (labels carry meaning). */
