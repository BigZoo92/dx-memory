import type { Signal, SignalsQuery } from '@signalops/contracts'
 ...
 */
export function matchesSignalFilters(signal: Signal, query: SignalsQuery): boolean {
...
export function filterSignals(signals: readonly Signal[], query: SignalsQuery): Signal[] {
